...
public class SlidingTabLayout extends HorizontalScrollView
{
    ...
    public interface TabColorizer
    {
        ...
        /**
         * @return return the color of the indicator used when {@code position} is setSelected.
         */
    ...
    /**
     * Sets the colors to be used for indicating the setSelected tab. These colors are treated as a
